...
fn main() {
    ...
    let news = NewsArticle {
        headline: "Cairo: El lenguaje del futuro".into(),
        location: "Mundo".into(),
        author: "Cairo Developer".into(),
        content: "Cairo está revolucionando el desarrollo de ZK".into(),
    };

    // Crear un tweet
    let tweet = Tweet {
        username: "CairoFan".into(),
        content: "¡Aprendiendo Cairo! #ZeroKnowledge".into(),
        reply: false,
        retweet: false,
    };

    // Demostrar el uso de los métodos del trait
    println!("=== Demostración de Traits en Cairo ===");
